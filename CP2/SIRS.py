...
def main():
    for prob1 in tqdm(np.arange(0, 1, 0.05)):  # increase prob1 by increment of 0.05.
        for prob3 in tqdm(np.arange(0, 1, 0.05)):  # increase prob3 by increment of 0.05.
            ...
            csv_wrtiter(prob1, prob3, averageI)    
def main3():
    prob1 = 0.4
    prob3 = 0.3
    size = 50  # size fixed as 50.
